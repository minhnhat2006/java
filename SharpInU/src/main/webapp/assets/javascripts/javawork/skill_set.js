...
function populateSkillsIntoBox(skills) {
	...
	for (var i = 0; i < skills.length; i++) {
		html = '<div class="text-contrast box-content"><i class="icon-exclamation-sign"></i>skillName<a class="btn btn-primary pull-right clearfix" href="contextPath/admin/skill/skillId/test.in"><i class="icon-check"></i>Take this test</a><div class="clearfix"></div></div>';
