...
<body class='contrast-red '>
	...
	<div class='row-fluid'>
		<div class='span12 box'>
			<div class='box-content'>
				<h4>
					<a href="${contextPath}/admin/jobs/${job.jobId}/view.in" class="text-contrast">${job.title }</a>
				</h4>
				<div class="row-fluid">
					<ul class="inline">
	...
	<div class='pagination pagination-centered'>
		<ul>
		<c:url var="prevUrl" value="/admin/jobs/${currentIndex - 1}/list.in" />
		<c:url var="nextUrl" value="/admin/jobs/${currentIndex + 1}/list.in" />
			<c:choose>
			...
			<c:forEach var="i" begin="${beginIndex}" end="${endIndex}">
				<c:url var="pageUrl" value="/admin/jobs/${i}/list.in" />
				<c:choose>
