			...
			<div class='row-fluid'>
		        ...
		        <div class="row-fluid test-disable">
		            <div class="span12 box">
			            <a class="btn btn-primary btn-large" href="${contextPath}/admin/skill/${skill.skillId}/test/practice.in">
		            	...
		            	<h4 class="title text-primary" id="question${question.questionId}">${question.stem}</h4>
			            	<c:forEach var="option" items="${question.options}">
			               	...
			               	<hr class="hr-normal">
			               	<a class="btn btn-primary btn-large pull-right" href="${contextPath}/admin/skill/${skill.skillId}/test/question.in">
