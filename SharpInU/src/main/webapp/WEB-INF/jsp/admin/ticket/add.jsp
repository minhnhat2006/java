	...
	<div class='row-fluid'>
		<div class='span12'>
			<div class='page-header'>
				<h1 class='pull-left'>
					<i class='icon-edit'></i> <span>Enhance Ticket for ${type}</span>
				</h1>
				...
				<div class='fuelux'>
					<div class='step-content'>
						<form:form accept-charset="UTF-8"
							action="${contextPath}/admin/ticket/${type}/${refId}/add.in"
							class="form form-striped" method="POST" commandName="ticketForm">
							<input type="hidden" name="${_csrf.parameterName}"
								value="${_csrf.token}" />
							<div class='step-pane active' id='step1'>
								<div class="control-group">
									<label for="selCategory" class="control-label">Ticket
										for ${refTitle}</label>
								</div>
								<div class='control-group'>
									<label class='control-label' for='txtSummary'>Title</label>
									<div class='controls'>
								...
								<div class="text-right">
									<a href="${contextPath}/admin/ticket/${userId}/1/list.in"
