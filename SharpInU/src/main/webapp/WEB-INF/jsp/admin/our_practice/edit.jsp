...
<html>
<head>
<title>Update Our Practice</title>
	...
	<div class='row-fluid'>
		<div class='span12'>
			<div class='page-header'>
				<h1 class='pull-left'>
					<i class='icon-edit'></i> <span>Update Our Practice</span>
				</h1>
				...
				<div class='fuelux'>
					<div class='step-content'>
						<form:form accept-charset="UTF-8"
							action="${contextPath}/admin/our_practice/${ourPracticeId}/edit.in"
							...
							<div class='step-pane active' id='step1'>
								...
								<div class='control-group'>
									<label class='control-label' for='txtSummary'>Our Practice
										Summary</label>
									<div class='controls'>
