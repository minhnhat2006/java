...
<html>
<head>
<title>Update Trend</title>
<script src='${contextPath}/assets/javascripts/admin/trend.js' type='text/javascript'></script>
</head>
	...
	<div class='row-fluid'>
		<div class='span12'>
			<div class='page-header'>
				<h1 class='pull-left'>
					<i class='icon-edit'></i> <span>Update Trend</span>
				</h1>
				...
				<div class='fuelux'>
					<div class='step-content'>
						<form:form accept-charset="UTF-8"
							action="${contextPath}/admin/trend/${trendId}/edit.in"
							class="form form-striped" method="POST" commandName="trendForm">
							<input type="hidden" name="${_csrf.parameterName}"
								value="${_csrf.token}" />
							<div class='step-pane active' id='step1'>
								<div class='control-group'>
									<label class='control-label' for='txtSummary'>Trend
										Summary</label>
									<div class='controls'>
										<form:input class='input-block-level' id='txtSummary'
											placeholder='Summary Trend' path="summary" />
									</div>
								...
								<div class='control-group'>
									...
									<div class='controls'>
										<form:textarea class='input-block-level' id='txtContent'
											placeholder='Content of Trend' rows='20' path="content" />
									</div>
									<form:errors path="content" cssClass="help-block error" />
								</div>

								<div class="text-right">
									<a href="${contextPath}/admin/trend/1/list.in"
