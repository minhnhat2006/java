	...
	<div class='row-fluid'>
		<div class='span12'>
			<div class='page-header'>
				<h1 class='pull-left'>
					<i class='icon-edit'></i> <span>Add Post</span>
				</h1>
				...
				<div class='fuelux'>
					<div class='step-content'>
						<form:form accept-charset="UTF-8"
							action="${contextPath}/admin/post/add.in"
							...
							<div class='step-pane active' id='step1'>
								...
								<div class="control-group">
									<label for="selScope" class="control-label">Select
										Scope</label>
									<div class="controls">
										<form:select id="selScope" path="isPublic"
											items="${scopes}" itemLabel="name" itemValue="value">
										</form:select>
									</div>
