	...
	<div class='row-fluid'>
		<div class='span12'>
			<div class='page-header'>
				<h1 class='pull-left'>
					<i class='icon-edit'></i> <span>Update Post</span>
				</h1>
				...
				<div class='fuelux'>
					<div class='step-content'>
						<form:form accept-charset="UTF-8"
							action="${contextPath}/admin/post/${postId}/edit.in"
							class="form form-striped" method="POST" commandName="postForm">
							<input type="hidden" name="${_csrf.parameterName}"
								value="${_csrf.token}" />
							<div class='step-pane active' id='step1'>
								<div class="control-group">
									<label for="selCategory" class="control-label">Select
										the category of Post</label>
									<div class="controls">
										<form:select id="selCategory" path="categoryId"
											items="${categories}" itemLabel="name" itemValue="categoryId">
										</form:select>
									</div>
									<form:errors path="categoryId" cssClass="help-block error" />
								</div>
								<div class="control-group">
									<label for="selScope" class="control-label">Select
										Scope</label>
									<div class="controls">
										<form:select id="selScope" path="isPublic" items="${scopes}"
											itemLabel="name" itemValue="value">
										</form:select>
									</div>
									<form:errors path="isPublic" cssClass="help-block error" />
								</div>
								<div class='control-group'>
									<label class='control-label' for='txtSummary'>Post
										Summary</label>
									<div class='controls'>
										<form:input class='input-block-level' id='txtSummary'
											placeholder='Summary Post' path="summary" />
									</div>
								...
								<div class='control-group'>
									...
									<div class='controls'>
										<form:textarea class='input-block-level' id='txtContent'
											placeholder='Content of Post' rows='20' path="content" />
									</div>
									<form:errors path="content" cssClass="help-block error" />
								</div>

								<div class="text-right">
									<a href="${contextPath}/admin/post/1/list.in"
