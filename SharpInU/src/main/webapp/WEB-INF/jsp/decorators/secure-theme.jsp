...
<link href='${contextPath}/assets/stylesheets/light-theme.css'
	...
	type='text/css' />
<!-- / demo -->
<link href='${contextPath}/assets/stylesheets/demo.css' media='all'
...
<!-- / input mask -->
<script
	src='${contextPath}/assets/javascripts/plugins/input_mask/bootstrap-inputmask.min.js'
	type='text/javascript'></script>
<!-- / fileinput -->
<script
	src='${contextPath}/assets/javascripts/plugins/fileinput/bootstrap-fileinput.js'
	type='text/javascript'></script>
<!-- / modernizr -->
<script
...
<script src='${contextPath}/assets/javascripts/demo/jquery.mockjax.js'
	type='text/javascript'></script>
<script src='${contextPath}/assets/javascripts/demo/inplace_editing.js'
	type='text/javascript'></script>
<script src='${contextPath}/assets/javascripts/demo/charts.js'
	type='text/javascript'></script>
