...
import com.sharpinu.service.IProfileService;
import com.sharpinu.service.IUCertificationService;
import com.sharpinu.service.IUEducationService;
import com.sharpinu.service.IUEmploymentService;
import com.sharpinu.service.IULicenseService;
import com.sharpinu.service.IUserService;
import com.sharpinu.web.common.util.SecurityUtil;
import com.sharpinu.web.form.ProfileForm;
import com.sharpinu.web.form.UCertificationForm;
import com.sharpinu.web.form.UEducationForm;
import com.sharpinu.web.form.UEmploymentForm;
import com.sharpinu.web.form.ULicenseForm;
import com.sharpinu.web.validator.ProfileFormValidator;
...
public class UserDashboardController extends BaseController {
	...
	protected void initBinder(WebDataBinder binder) {
		SimpleDateFormat dateFormat = new SimpleDateFormat(com.sharpinu.constant.WebConstants.FixValue.DEFAULT_DATE_FORMAT);
	...
	/** View Dash board */
	@RequestMapping(value = "/admin/dashboard_old")
	...
	/** User Profile */
	@RequestMapping(value = "/admin/dashboard/updateOverviewProfile", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/admin/dashboard/updateServiceDescriptionProfile", method = RequestMethod.POST)
	...
	/** UCertification */
	@RequestMapping(value = "/admin/dashboard/createUCertification", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/admin/dashboard/{uCertificationId}/updateUCertification", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/admin/dashboard/{uCertificationId}/deleteUCertification")
	...
	@RequestMapping(value = "/admin/dashboard/createUEducation")
	...
	@RequestMapping(value = "/admin/dashboard/{uEducationId}/updateUEducation")
	...
	@RequestMapping(value = "/admin/dashboard/{uEducationId}/deleteUEducation")
	...
	@RequestMapping(value = "/admin/dashboard/createUEmployment")
	...
	@RequestMapping(value = "/admin/dashboard/{uEmploymentId}/updateUEmployment")
	...
	@RequestMapping(value = "/admin/dashboard/{uEmploymentId}/deleteUEmployment")
	...
	@RequestMapping(value = "/admin/dashboard/createULicense")
	...
	@RequestMapping(value = "/admin/dashboard/{uLicenseId}/updateULicense")
	...
	@RequestMapping(value = "/admin/dashboard/{uLicenseId}/deleteULicense")
