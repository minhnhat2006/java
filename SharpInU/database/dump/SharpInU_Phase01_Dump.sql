...
MySQL - 5.6.11 : Database - sharpinu
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`sharpinu` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
DROP TABLE IF EXISTS `email_system`;
...
/*Data for the table `email_system` */

insert  into `email_system`(`EMAIL_SYSTEM_ID`,`PROTOCOL`,`HOST`,`PORT`,`USER_NAME`,`PASSWORD`,`ACTIVE`,`IS_DEFAULT`,`DATE_CREATED`,`SENDER_EMAIL`) values (1,'smtp','smtp.gmail.com',587,'sharpinu.tester','sharpinu','Y',1,'2015-01-25 11:52:51',NULL);
...
CREATE TABLE `job` (
  ...
  `JOB_TYPE` enum('Full Time','Part Time') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'Full Time',
...
CREATE TABLE `t_user_test` (
  ...
  `FINISHED_DATED` datetime DEFAULT NULL,
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `t_test_update_date_updated` */$$
